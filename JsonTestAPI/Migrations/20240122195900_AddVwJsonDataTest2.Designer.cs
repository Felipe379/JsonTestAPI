...
namespace JsonTestAPI.Migrations
{
    ...
    [Migration("20240122195900_AddVwJsonDataTest2")]
    partial class AddVwJsonDataTest2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JsonTestAPI.Core.Entities.JsonDataTest2Query", b =>
                {
                    b.Property<string>("ComplexSerializedData1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Id")
                        .HasColumnType("int");

                    b.Property<string>("MultipleComplexSerializedData1")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable((string)null);

                    b.ToView("vWJsonDataTest2", (string)null);
                });
                    ...
                    b.OwnsOne("JsonTestAPI.Core.Entities.ComplexSerializedData2", "ComplexSerializedData2", b1 =>
                        {
                            ...
                            b1.OwnsOne("JsonTestAPI.Core.Entities.ComplexSerializedData1", "ComplexSerializedData", b2 =>
                                {
                                    b2.Property<int>("ComplexSerializedData2JsonDataTest2Id")
                                        .HasColumnType("int");

                                    b2.Property<DateTime?>("DateTimeFillerProperty1")
                                        .HasColumnType("datetime2");

                                    b2.Property<DateTimeOffset?>("DateTimeOffsetFillerProperty1")
                                        .HasColumnType("datetimeoffset");

                                    b2.Property<int?>("FillerEnumInt1")
                                        .HasColumnType("int");

                                    b2.Property<int?>("FillerEnumString1")
                                        .HasColumnType("int");

                                    b2.Property<string>("FillerInt")
                                        .HasColumnType("nvarchar(max)");
                            ...
                            b1.OwnsMany("JsonTestAPI.Core.Entities.ComplexSerializedData1", "MultipleComplexSerializedData", b2 =>
                                {
                                    b2.Property<int>("ComplexSerializedData2JsonDataTest2Id")
                                        .HasColumnType("int");
                                    ...
                                    b2.HasKey("ComplexSerializedData2JsonDataTest2Id", "Id");
                            ...
                            b1.OwnsMany("JsonTestAPI.Core.Entities.ComplexSerializedData1", "MultipleComplexSerializedData", b2 =>
                                {
                                    ...
                                    b2.HasKey("ComplexSerializedData2JsonDataTest2Id", "ComplexSerializedData2Id", "Id");
